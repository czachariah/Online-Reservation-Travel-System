...
<title>Choose Aircraft To Delete</title>
</head>
<body>
...
<h2>Choose the aircraft to delete:</h2>
<form method = "post" action = "DeleteAircraftDB.jsp">
...
<input type = "submit" value = "Delete this aircraft (cannot be undone)">
</form>
