...
<title>Choose Flight To Edit</title>
</head>
<body>
...
while(result.next()) {
	...
	out.print("<h2><option value = \"" + flight_number + "\">" + "Flight Number: " + flight_number + " Date of Flight: " + date_of_flight + " Departure Time: " + departure_time + " Arrival Time: " + arrival_time + " Departure Airport ID: " + departure_airport_ID + " Arrival_Airport_ID: " + arrival_airport_ID + "</h2>"); 
}
result.close();
ps.close();
